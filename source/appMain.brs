...
Sub Main()
    ...
    initTheme()
    'Create an instance of GA and initialize it
    m.ga = GA()
...
Sub showGridScreen()
    ...
    m.ga.init(m.GA_UID,true) 'Session init
...
Function playAsset(asset as Object, backlotAsset as Object)
    ...
    m.ga.setContentMetadata({duration : asset.length, assetId : assetId, title: asset.Title })
